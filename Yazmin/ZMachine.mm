...
//                parts->_memory->dump();
            ...
            parts->_proc = new ZMProcessor(*parts->_memory,
                                           *parts->_stack,
                                           *parts->_io,
                                           *parts->_error);
        }
...
- (NSString *)ifid
{
    ...
    [ifidString appendFormat:@"ZCODE-%d-", parts->_memory->getHeader().getRelease()];
    ...
    {
        NSString *checksumString = [NSString stringWithFormat:@"-%02X",
