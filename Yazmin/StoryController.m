...
//    container = [[NSTextContainer alloc] initWithContainerSize:upperFrame.size];
//    [container setWidthTracksTextView:YES];
...
- (void)characterInput:(char)c
{
    ...
    if (story.hasEnded)
    {
        NSMutableString *windowTitle = [NSMutableString stringWithString:self.window.title];
...
- (IBAction)showInformationPanel:(id)sender
{
    ...
    {
        Story *story = self.document;
        informationController = [[StoryInformationController alloc] initWithBlorb:story.blorb];
