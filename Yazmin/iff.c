...
{
    if (((const char *)data)[0] == c1
        && ((const char *)data)[1] == c2
        && ((const char *)data)[2] == c3
        && ((const char *)data)[3] == c4)
        return 1;
    else
        return 0;
}
...
static void expandBufferIfNeeded(IFFHandle *handle, unsigned long additionalLen)
{
