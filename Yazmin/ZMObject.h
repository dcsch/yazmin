...
public:
    ...
    static int getPropertyAtAddress(const ZMMemory& memory,
                                    uint16_t addr,
                                    uint8_t *size,
    ...
    static uint16_t getPropertyTableAddress(ZMMemory& memory, uint16_t objectDataLocation);
...
private:
    ...
    int getPropertyAtAddress(uint16_t addr,
                             uint8_t *size,
                             uint16_t *propertyAddr,
